/**
 * /dates layout — shared between Heo and Masuri.
 *
 * Mirrors the /calendar layout so every Phase 2 dates page gets the
...
export default async function DatesLayout({ children }: { children: React.ReactNode }) {
